#----------------------------------------------------------------------
#   
#   Project:            Level Blue on the other side
#   Description:        Get a blue and yellow goal leveled
#                       
#   Date:               26.11.2021
...
def main():
    ...
    stage = "move red goal in home zone" 
    move("right", 1100, 0)
    move("up",    -900, 0)
    pick_up()
    move("left",  -920, 0)
    ...
    # We never get here - 60 seconds are over
