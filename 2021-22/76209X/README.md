...
<variables>
	...
	<variable type=\"\" id=\"3,?igH1K_s+v)(vfwq3l\" islocal=\"false\" iscloud=\"false\" arraylength=\"0\" arraywidth=\"0\">y1</variable>
</variables>
		...
		<block type=\"v5_variables_set_variable\" id=\"uxF]dbyihPHEp7KL!L}P\">
			...
			<block type=\"v5_sensing_calibrate_gyro\" id=\"M1GreP?|SFtH2bIC:N}6\">
				...
				<block type=\"procedures_call\" id=\"4)l`1ahI|S_[x#7]4]{,\">
					<mutation proccode=\"Goto %n x %n y\" proceduredefid=\"dLr)pJCUCcAehw4|j?2a\" argumentids=\"[&quot;V/m()E{96Jt(I6ykh=pX&quot;,&quot;Dn{kF`=CPnbCl(DDi+O8&quot;]\" warp=\"false\">
					</mutation>
